...
public class ArucasImportClassNameImpl extends ArucasNameImpl implements ArucasImportClassName {

  public ArucasImportClassNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArucasVisitor visitor) {
    visitor.visitImportClassName(this);
  }
