...
public class ArucasArgumentArbitraryImpl extends ASTWrapperPsiElement implements ArucasArgumentArbitrary {

  public ArucasArgumentArbitraryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArucasVisitor visitor) {
    visitor.visitArgumentArbitrary(this);
  }
