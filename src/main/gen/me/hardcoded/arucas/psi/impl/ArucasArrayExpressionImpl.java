...
public class ArucasArrayExpressionImpl extends ArucasExpressionImpl implements ArucasArrayExpression {

  public ArucasArrayExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
