...
public class ArucasEnumCodeBlockImpl extends ArucasStatementImpl implements ArucasEnumCodeBlock {

  public ArucasEnumCodeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ArucasVisitor visitor) {
    visitor.visitEnumCodeBlock(this);
  }
  ...
  @Override
  @Nullable
  public ArucasEnumCodeValues getEnumCodeValues() {
    return findChildByClass(ArucasEnumCodeValues.class);
  }
