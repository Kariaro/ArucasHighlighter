...
public class ArucasConditionalAndExpressionImpl extends ArucasExpressionImpl implements ArucasConditionalAndExpression {

  public ArucasConditionalAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
