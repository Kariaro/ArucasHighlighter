...
public class ArucasTryStatementFinallyImpl extends ASTWrapperPsiElement implements ArucasTryStatementFinally {

  public ArucasTryStatementFinallyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ArucasVisitor visitor) {
    visitor.visitTryStatementFinally(this);
  }
