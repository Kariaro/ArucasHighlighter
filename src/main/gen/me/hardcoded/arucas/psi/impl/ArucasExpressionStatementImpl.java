...
public class ArucasExpressionStatementImpl extends ArucasStatementImpl implements ArucasExpressionStatement {

  public ArucasExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
