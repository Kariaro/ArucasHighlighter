...
public class ArucasParenthesesExpressionImpl extends ArucasExpressionImpl implements ArucasParenthesesExpression {

  public ArucasParenthesesExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
