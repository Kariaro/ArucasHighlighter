...
public class ArucasListExpressionImpl extends ArucasExpressionImpl implements ArucasListExpression {

  public ArucasListExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
