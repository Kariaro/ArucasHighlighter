...
public class ArucasAssignExpressionImpl extends ArucasExpressionImpl implements ArucasAssignExpression {

  public ArucasAssignExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
