...
public class ArucasContinueStatementImpl extends ArucasStatementImpl implements ArucasContinueStatement {

  public ArucasContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
