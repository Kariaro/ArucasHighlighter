...
public class ArucasUnaryExpressionImpl extends ArucasExpressionImpl implements ArucasUnaryExpression {

  public ArucasUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
